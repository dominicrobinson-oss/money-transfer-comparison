...
const MOCK_QUOTES = {
  wise: {
    ...
    rate: 1.28,
    fee: 3.5,
    receiveAmount: (DEFAULT_SEND_AMOUNT - 3.5) * 1.28,
  ...
  remitly: {
    ...
    rate: 1.27,
    fee: 2.99,
    receiveAmount: (DEFAULT_SEND_AMOUNT - 2.99) * 1.27,
    fetchedAt: MOCK_TIMESTAMP,
    source: "mock" as const,
  },
  worldremit: {
    ...
    rate: 1.26,
    fee: 3.99,
    receiveAmount: (DEFAULT_SEND_AMOUNT - 3.99) * 1.26,
    fetchedAt: MOCK_TIMESTAMP,
    source: "mock" as const,
  },
  sendwave: {
    ...
    rate: 1.29,
    fee: 0,
    receiveAmount: DEFAULT_SEND_AMOUNT * 1.29,
    fetchedAt: MOCK_TIMESTAMP,
    source: "mock" as const,
  },
  taptapsend: {
    ...
    rate: 1.28,
    fee: 1.99,
    receiveAmount: (DEFAULT_SEND_AMOUNT - 1.99) * 1.28,
    fetchedAt: MOCK_TIMESTAMP,
    source: "mock" as const,
  },
};

export default function GbpToUsdPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-600 mb-6">Sending £{formatNumber(parseFloat(sendAmount) || 0, 2)} to United States</p>
        ...
        <section className="mt-12 border-t pt-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Which provider offers the best GBP to USD rate?</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">How much does it cost to send money GBP to USA?</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">How long does a GBP to USD transfer take?</h3>
