...
const MOCK_QUOTES = {
  wise: {
    ...
    rate: 1.18,
    fee: 3.5,
    receiveAmount: (DEFAULT_SEND_AMOUNT - 3.5) * 1.18,
  ...
  remitly: {
    ...
    rate: 1.17,
    fee: 2.99,
    receiveAmount: (DEFAULT_SEND_AMOUNT - 2.99) * 1.17,
    fetchedAt: MOCK_TIMESTAMP,
    source: "mock" as const,
  },
  worldremit: {
    ...
    rate: 1.16,
    fee: 3.99,
    receiveAmount: (DEFAULT_SEND_AMOUNT - 3.99) * 1.16,
    fetchedAt: MOCK_TIMESTAMP,
    source: "mock" as const,
  },
  sendwave: {
    ...
    rate: 1.19,
    fee: 0,
    receiveAmount: DEFAULT_SEND_AMOUNT * 1.19,
    fetchedAt: MOCK_TIMESTAMP,
    source: "mock" as const,
  },
  taptapsend: {
    ...
    rate: 1.18,
    fee: 1.99,
    receiveAmount: (DEFAULT_SEND_AMOUNT - 1.99) * 1.18,
    fetchedAt: MOCK_TIMESTAMP,
    source: "mock" as const,
  },
};

export default function GbpToEurPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-600 mb-6">Sending £{formatNumber(parseFloat(sendAmount) || 0, 2)} to Europe</p>
        ...
        <section className="mt-12 border-t pt-8">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Which provider offers the best GBP to EUR rate?</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">How much does it cost to send money GBP to Europe?</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">How long does a GBP to EUR transfer take?</h3>
