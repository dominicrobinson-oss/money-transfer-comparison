...
const TO_CURRENCY = "ZAR" as const;
  ...
  return (
    <main className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-600 mb-6">Sending £{formatNumber(parseFloat(sendAmount) || 0, 2)} to South Africa</p>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-4 py-4 text-right font-semibold text-gray-900">
                            R {formatNumberLocale(adjustedQuote.receiveAmount, 2)}
                          </td>
